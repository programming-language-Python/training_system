$(document).ready(function () {
        ...
        function block_or_unblock_fields() {
            let id_is_if_statement = $('#id_is_if_operator'),
                field_condition_of_if_operator = $('#id_condition_of_if_operator'),
            ...
            function block_or_unblock_field() {
                block_or_unblock_field_select(id_is_if_statement, field_condition_of_if_operator)
                block_or_unblock_field_multiple_select(id_presence_one_of_cycles, blocking_fields)
            }
