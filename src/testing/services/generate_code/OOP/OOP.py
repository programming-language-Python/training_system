...
from testing.services.generate_code.OOP.generate_OOP_with_methods import \
    GenerateOOPWithMethods
from testing.services.generate_code.OOP.generate_OOP_with_return import \
    GenerateOOPWithReturn
from testing.services.generate_code.OOP.generate_OOP_without_methods import \
